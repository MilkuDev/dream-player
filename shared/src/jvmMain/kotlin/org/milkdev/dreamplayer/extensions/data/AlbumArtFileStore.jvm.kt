...
actual fun createAlbumArtFileStore(): AlbumArtFileStore {
    return JvmAlbumArtFileStore(File(applicationDirectory, "album-art/remote"))
}

private class JvmAlbumArtFileStore(
    ...
    override suspend fun saveRemoteAlbumArt(
        ...
        directory.mkdirs()
        val finalFile = File(directory, "$albumId-${sourceUrl.stableHash()}.${contentType.fileExtension(sourceUrl)}")
